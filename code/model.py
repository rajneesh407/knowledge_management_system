import os 
from prompt_library import summarization_prompt_text_or_table, description_prompt_image, answer_using_context_prompt
from langchain.embeddings import HuggingFaceEmbeddings
from langchain_core.runnables import RunnablePassthrough, RunnableLambda
from utils import parse_docs_for_images_and_texts
...
def build_prompt_for_response_model(kwargs):
    ...
    answer_prompt = answer_using_context_prompt.format(context=context_text, question=user_question)
